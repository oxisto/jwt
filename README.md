...
* The [EdDSA signing method](https://pkg.go.dev/github.com/golang-jwt/jwt#SigningMethodEdDSA) (`EdDSA`) expect `*ed25519.PrivateKey` for signing and `*ed25519.PublicKey` for validation
