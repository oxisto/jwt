...
* The [ED25519 signing method](https://pkg.go.dev/github.com/golang-jwt/jwt#SigningMethodED25519) (`EdDSA`) expect `*ed25519.PrivateKey` for signing and `*ed25519.PublicKey` for validation
